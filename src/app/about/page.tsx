		...
		<>
			...
			<section className='flex max-w-7xl mx-auto min-h-[80dvh] flex-wrap items-center justify-between lg:flex-nowrap py-16 px-4'>
				<div className='w-full text-center flex flex-col justify-center gap-4 lg:text-start lg:w-1/2'>
					...
					<p className='text-xl text-gray-300'>
						...
						journeys. Our approach blends deep technical insight with simplified
						learning methods.
					</p>
					<p className='text-md text-gray-400'>
						Santosh Devare was honored by TradingView for analyzing the most
						stocks under a single profile. He has educated more than{" "}
						<strong>1000 students</strong> across India and beyond. His
						proprietary TradingView analysis tool boasts a{" "}
						<strong>99%+ accuracy guarantee</strong>, helping users make
						informed, confident trades.
					</p>
			...
			<section className='bg-[#020f29] py-16 px-4'>
				<div className='max-w-6xl mx-auto text-center'>
					...
					<p className='text-lg text-gray-300 max-w-3xl mx-auto mb-4'>
						At ProMaker Institute, we envision building a financially
						independent community by demystifying the stock market. Our core
						values revolve around integrity, transparency, and result-oriented
						mentorship.
					</p>
					<div className='mt-8 grid grid-cols-1 md:grid-cols-3 gap-8'>
						<div className='bg-gray-900 p-6 rounded-xl shadow-xl'>
							...
							<p className='text-gray-400'>
								We share what works — real strategies with real data and
								results.
							</p>
						</div>
						<div className='bg-gray-900 p-6 rounded-xl shadow-xl'>
							...
							<p className='text-gray-400'>
								Our custom-built TradingView tools deliver 99%+ reliable market
								calls.
							</p>
						</div>
						<div className='bg-gray-900 p-6 rounded-xl shadow-xl'>
							...
							<p className='text-gray-400'>
								We educate and equip you to trade independently with confidence.
							</p>
						</div>
					</div>
				</div>
			...
			<section className='bg-[#020f29] py-16 px-4'>
				<div className='max-w-4xl mx-auto'>
					<h2 className='text-4xl font-bold text-center text-sky-400 mb-10'>
						Frequently Asked Questions
					</h2>
					<div className='space-y-6'>
						<div className='bg-gray-900 p-6 rounded-xl'>
							<h3 className='text-lg font-semibold text-white mb-2'>
								What makes your TradingView tool special?
							</h3>
							<p className='text-gray-400'>
								It is a proprietary indicator developed over years of real
								market experience and backtesting — delivering over 99% accurate
								signals.
							</p>
						</div>
						<div className='bg-gray-900 p-6 rounded-xl'>
							<h3 className='text-lg font-semibold text-white mb-2'>
								Can a beginner join your courses?
							</h3>
							<p className='text-gray-400'>
								Absolutely. We have tailored content from beginner to advanced
								levels, with live support and mentorship included.
							</p>
						</div>
						<div className='bg-gray-900 p-6 rounded-xl'>
							<h3 className='text-lg font-semibold text-white mb-2'>
								Is there a guarantee for profits?
							</h3>
							<p className='text-gray-400'>
								While no one can promise profits in the market, our goal is to
								make you an informed and disciplined trader with data-backed
								strategies.
							</p>
						</div>
					</div>
